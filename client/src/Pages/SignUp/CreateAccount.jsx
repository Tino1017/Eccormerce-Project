...
export const CreateAccount = () => {
  ...
  return (
    <>
    <form action="submit" className='relative flex h-[95vh] items-center justify-center '>
      <div className='relative z-[1] flex flex-col mx-auto text-center px-8 py-16 shadow-lg space-y-5 bg-white/65 rounded-lg' >
        <h1 className='text-4xl font-medium mb-5'>Create Account</h1>
        ...
        <input type="email" placeholder='Email Address' className='bg-transparent border-[1.5px] rounded-lg p-2 border-gray-500  outline-none' required />
        <input type="password" placeholder='Create Password' className='bg-transparent border-[1.5px] rounded-lg p-2 border-gray-500  outline-none' required/>
        <input type="password" placeholder='Confirm Password'className='bg-transparent border-[1.5px] rounded-lg p-2 border-gray-500  outline-none'  required  />
        <SquarePrimaryBtn 
